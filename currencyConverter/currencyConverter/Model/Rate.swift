...
class Rate: Hashable {
    ...
    init(currencyCode: String, value: Double, bookMarked: Bool) {
...
extension Rate {
    private func mapCodeandCountry(_ code: String) -> String {
        let mapInfo = [
            "USD": "미국",
            "AED": "아랍에미리트",
            "AFN": "아프가니스탄",
            ...
            "ZMW": "잠비아",
            "ZWL": "짐바브웨",
            "CNH": "중국", // 중국 역외 위안화 (홍콩처럼 중국 외부에서 거래되는 위안화 환율)
            "CLF": "칠레" // 칠레 물가 반영 화폐 - 인플레이션 상황에 따라 변동
            ]
